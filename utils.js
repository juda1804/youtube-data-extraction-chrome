// YouTube to n8n Extension - Shared Utilities
// This module contains common functions used across the extension
 ...
 */
function createPostId(author, content, time = '') {
 ...
 */
function createNotificationId(author, content, time = '') {
...
// For ES6 modules (background.js, database.js)
export {
  simpleHash,
  createPostId,
